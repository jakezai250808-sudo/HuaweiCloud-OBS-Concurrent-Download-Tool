...
MERGE INTO obs_account (id, account_name, access_key, secret_key, endpoint, bucket, created_at, updated_at)
    KEY (id) VALUES
(3, 'byh', 'HPUAGQKBSEGEBXAGQEHD', 'ZPZmSswwfjmb3zpLRoVsx638yGWvQQ7zPZIYn8Rl', 'obs.cn-east-3.myhuaweicloud.com', 'picgo-cn-east-3-j', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
